...
def payment_process(request):
    ...
    if request.method == 'POST':
        ...
        if result.is_success:
            ...
            subject = 'MyFavoriteLibrary (MFL) - Invoice no. {}'.format(order.id)
            message = 'Hello {} {}, \n\n Thank you for shopping at MyFavoriteLibrary.\n We hope you will enjoy reading your book. ' \
                      ...
                      'Your total bill is ${}'.format(order.first_name, order.last_name, order.get_total_cost())
            email = EmailMessage(subject,
                                 message,
                                 'isqa3900team12@gmail.com',
                                 [order.email])
            # generate PDF
